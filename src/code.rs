...
impl<'a> Struct<'a> {
    ...
    fn attr_derive(&self) -> String {
        format!("#[derive(Debug, Serialize, Deserialize, Clone, Queryable, Insertable{derive_aschangeset}{derive_identifiable}{derive_associations}{derive_selectable}{derive_default})]",
